...
$consulta = "SELECT * from fotografiaproduccionmultimedia";
$i=0;
$idc="";
$imagen="";
$servicios="";
...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Fotografía y Producción Multimedia</title>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Seccion de Fotografía y Producción Multimedia</h1>
        </div>
        ...
        <?php echo $mensaje;?>
        <h4>Contenido Publicado en la seccion de Fotografia y Produccion Multimedia</h4>
        ...
        <h4>Actualiza tu contenido</h4>
          <form action="Fotografia/Actualizar.php" method="post">
          <div class="form-group" >
                              <label for="validationCustom03">Solo se permite 30 caracteres para actualizar el titulo</label>
                              <textarea style="resize:none;" name="Fotografia" maxlength="300" class="form-control" id="validationCustom03" rows="3" required></textarea>
...
<script>
        ...
        <div class="pt-3 pb-2 mb-3 border-bottom">
      <form action="Fotografia/ActualizarImg.php" method="post" onSubmit="return validar()"  enctype="multipart/form-data">
