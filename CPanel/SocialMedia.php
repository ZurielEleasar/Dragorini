...
$consulta = "SELECT * from socialmedia";
$i=0;
$idc="";
$servicios="";
$imagen="";
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
             <h1 class="h2">Seccion de Social Media</h1>
        </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php echo $mensaje;?>
                <h4>Contenido Publicado en la seccion de social media de la pagina web</h4>
                <div class="form-group" >
                    <textarea style="resize:none;" maxlength="30" class="form-control"  disabled  id="exampleFormControlTextarea1" rows="3"><?php echo $Cambio_Contenido ?></textarea>
                </div>
                </div>
                
              <div class="pt-3 pb-2 mb-3 border-bottom">
                <h4>Actualiza tu contenido</h4>
                  <form action="SocialMedia/Actualizar.php" method="post">
                  <div class="form-group" >
                              <label for="validationCustom03">Actualize el contenido</label>
                              <textarea style="resize:none;" name="SocialMedia" maxlength="255" class="form-control" id="validationCustom03" rows="3" required></textarea>
              ...
              <div class="pt-3 pb-2 mb-3 border-bottom">
                <h4>Imagen publicada en la seccion de social media</h4>
            ...
            function validar() {
              ...
              <div class="pt-3 pb-2 mb-3 border-bottom">
                  <form action="SocialMedia/ActualizarImg.php" onSubmit="return validar()" method="post"  enctype="multipart/form-data">
