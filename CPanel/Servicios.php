    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Seccion de Servicios</h1>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="pt-3 pb-2 mb-3 border-bottom">
                  <?php echo $mensaje;?>
                  <h4>Contenido Publicado en la seccion de servicios de la pagina web</h4>
              ...
              <h4>Actualiza tu contenido</h4>
                <form action="Servicios/Actualizar.php" method="post">
                <div class="form-group" >
                              <label for="validationCustom03">Describa la nueva descripción</label>
                              <textarea style="resize:none;" name="Servicios" maxlength="255" class="form-control" id="validationCustom03" rows="3" required></textarea>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          Una vez actualizado la seccion de Servicios, no se podra revertir los cambios
                        </div>
                        <div class="modal-footer">
