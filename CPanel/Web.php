...
$consulta = "SELECT * from disenoweb";
$i=0;
$idc="";
$imagen="";
$servicios="";
...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Diseño Web</title>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Seccion de Diseño Web</h1>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="pt-3 pb-2 mb-3 border-bottom">
                  <?php echo $mensaje;?>
                  <h4>Contenido Publicado en la seccion de Diseño Web</h4>                 
                ...
                <h4>Actualiza tu contenido</h4>
                  <form action="Web/Actualizar.php" method="post">
                  <div class="form-group" >
                              <label for="validationCustom03">Actualize su contenido</label>
                              <textarea style="resize:none;" name="Web" maxlength="255" class="form-control" id="validationCustom03" rows="3" required></textarea>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Una vez actualizada esta seccion, no se podra revertir los cambios
                          </div>
                          <div class="modal-footer">
                ...
                <div class="pt-3 pb-2 mb-3 border-bottom">
                  <h4>Imagen Publicada en la seccion Web</h4>
...
<script>
            ...
            function validar() {
              ...
              img.onload = function dimension() {
                if (this.width.toFixed(0) != 451  && this.height.toFixed(0) != 451) {
              ...
              return false;
                ...
                <div class="pt-3 pb-2 mb-3 border-bottom">
                  <form action="Web/ActualizarImg.php" method="post" onSubmit="return validar()"  enctype="multipart/form-data">
                  <h2 class="card-inside-title">La nueva Imagen debera de tener 451 px de alto por 451 px de ancho</h2>
                      <div class="form-group">
                        <div class="form-line">
