...
$consulta = "SELECT * from personalbranding";
$i=0;
$idc="";
$imagen="";
$servicios="";
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Seccion de Personal Branding</h1>
        </div>
        ...
        <?php echo $mensaje;?>
        <h4>Contenido Publicado en la seccion de Personal Branding de la pagina web</h4>
        ...
        <h4>Actualiza tu contenido</h4>
          <form action="PersonalBranding/Actualizar.php" method="post">
          <div class="form-group" >
                              <label for="validationCustom03">Actualice el contenido</label>
                              <textarea style="resize:none;" name="Personal" maxlength="300" class="form-control" id="validationCustom03" rows="3" required></textarea>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Una vez actualizado la seccion de Personal Branding no se podra revertir los cambios
      </div>
      <div class="modal-footer">
        ...
        <div class="pt-3 pb-2 mb-3 border-bottom">
      <form action="PersonalBranding/ActualizarImg.php" method="post" onSubmit="return validar()" enctype="multipart/form-data">
