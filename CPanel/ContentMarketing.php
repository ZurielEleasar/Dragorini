...
$consulta = "SELECT * from contentmarketing";
$i=0;
$idc="";
$imagen="";
$servicios="";
...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Content Marketing</title>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Seccion de Content Marketing</h1>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
               <div class="pt-3 pb-2 mb-3 border-bottom">
                <?php echo $mensaje;?>
                <h4>Contenido Publicado en la seccion de Content Marketing de la pagina web</h4>
                <div class="form-group" >
                  <textarea style="resize:none;" maxlength="255" class="form-control"  disabled  id="exampleFormControlTextarea1" rows="3"><?php echo $Cambio_Contenido ?></textarea>
                 </div>                
              </div>
                  
                <div class="pt-3 pb-2 mb-3 border-bottom">
                <h4>Actualiza tu contenido</h4>
                  <form action="ContentMarketing/Actualizar.php" method="post"> 
                  <div class="form-group" >
                              <label for="validationCustom03">Actualiza el contenido</label>
                              <textarea style="resize:none;" name="Content" maxlength="255" class="form-control" id="validationCustom03" rows="3" required></textarea>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Una vez actualizado la seccion de Content Marketing, no se podra revertir los cambios
                          </div>
                          <div class="modal-footer">
...
<script>
            ...
            function validar() {
              ...
              return false;
                ...
                <div class="pt-3 pb-2 mb-3 border-bottom">
                  <form action="ContentMarketing/ActualizarImg.php" method="post" onSubmit="return validar()"  enctype="multipart/form-data">
                  <h2 class="card-inside-title">La nueva Imagen debera de tener 551 px de alto por 551 px de ancho</h2> <h2 class="card-inside-title">Imagen de la Oferta</h2>
                      <div class="form-group">
                        <div class="form-line">
