...
$consulta = "SELECT imagen from disenoweb Where id='1'";
$i=0;
$idc="";
$Imagen="";
...
if (move_uploaded_file($nombre_archivo_temporal, $destino))
    {
        $sqlo="update disenoweb set imagen='$nombre_archivo_original' WHERE id='1'";
            ...
            if($resultado1 =='1')
            {
                ...
                {
                    header("location:../Web.php?accion=updateC");
                }
            }
            else
            {
